...
//							+ allCourseSlots.size() + "fertig.");
	 ...
	 * Falls dies zu einem h�heren Gl�ckswert f�hrt.
	...
	/**
	 * Eine Hilfsmethode welche die jeweiligen Ungl�cklichsten Studenten von zwei Praktikumsterminen tauscht.
	 * Falls dies zu einem h�heren Gl�ckswert f�hrt.
	 * @param CS1 Der erste Praktikumstermin
	 * @param CS2 Der zweite Praktikumstermin
	 * @return true wenn getauscht wurde, false wenn nicht
	...
	/**
	 * Eine Hilfsmethode welche die theoretischen neuen Gl�ckswerte f�r eine Gruppe ausrechnet, falls der newStud mit dem oldStud tauscht.
	 * @param CS der zu �berpr�fende Praktikumstermin
	 * @param newStud der Student f�r den die Gl�ckswerte ausgerechnet werden
